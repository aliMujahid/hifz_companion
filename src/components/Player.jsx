...
export default function Player({ayahNumberFirst, totalAyah, setPlayerPageCurrentTrackIndex, showText, toggleShowText}){
   ...
   const PlaybackOptions = ({ isExpanded, showText }) => (
    <Box
      sx={{
        ...
        ...(showText && {
          ...
          top: "auto", 
          right: 0,
          bottom: "100%", // Position above the main player bar
          width: { xs: 250, sm: 300, md: 350 }, // Fixed width for dropdown
          zIndex: 1301,
          boxShadow: 3,
          transformOrigin: "bottom right",
          animation: isExpanded ? "slideUp .2s ease-out forwards" : "slideDown .2s ease-in forwards",
          "@keyframes slideUp": {
    ...
    >
      ...
      <Box sx={{ display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap" }}>
        <Typography variant="body2" sx={{ fontWeight: "bold" }}>
         ...
         <Box sx={{ display: "flex", alignItems: "center", gap: 1 }}>
            <CustomTextField setOuterValue={setRepeatCount} outerValue={repeatCount} />
      ...
      <Box sx={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
        ...
        <Box sx={{ display: "flex", alignItems: "center", gap: 1 }}>
          <CustomTextField outerValue={gapSeconds} setOuterValue={setGapSeconds} />
          <Typography variant="caption" color="text.secondary" sx={{ minWidth: 40 }}>
            seconds
          </Typography>
        </Box>
      ...
      <Box sx={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
        ...
        <Box sx={{ display: "flex", alignItems: "center", gap: 1 }}>
            <CustomTextField setOuterValue={setLoopCount} outerValue={loopCount} />
            <Typography variant="caption" color="text.secondary" sx={{ minWidth: 40 }}>
            times
          </Typography>
          </Box>
      ...
      <Box sx={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
        ...
        <Tooltip title={showText ? "Text is Visible" : "Text is Hidden"} >
          <IconButton
            ...
            sx={{
              border: showText ? `2px solid ${theme.palette.primary.main}` : `2px solid ${theme.palette.divider}`,
              backgroundColor: showText ? theme.palette.primary.main + "1A" : "transparent",
              p: "6px",
              mr:8,
            }}
          >
  ...
  const PlayerControls = (
    ...
    >
      ...
      >
        ...
        <Box>
          <Tooltip title={isExpanded ? "Hide Playback Options" : "Show Playback Options"}>
            <IconButton
