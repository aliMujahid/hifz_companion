...
const AyahText = ({ ayahNumberFirst, ayahList, currentAyahTextIndex }) => {
  ...
  useEffect(() => {
    ...
    if (currentItemRef) {
      // Get the height of the current element and the viewport
      const elementHeight = currentItemRef.offsetHeight;
      const viewportHeight = window.innerHeight;

      // Decide whether to scroll to "center" or "start"
      const scrollBlockOption =
        elementHeight > viewportHeight ? "start" : "center";
